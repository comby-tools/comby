...
|}];
  ...
  if not String.(slow_result = fast_result) then
    ...
    print_string fast_result;
  [%expect_exact {|{"uri":"file","matches":[{"range":{"start":{"offset":0,"line":1,"column":1},"end":{"offset":11,"line":1,"column":12}},"environment":[{"variable":"1","value":"world","range":{"start":{"offset":6,"line":1,"column":7},"end":{"offset":11,"line":1,"column":12}}}],"matched":"hello world"},{"range":{"start":{"offset":12,"line":2,"column":1},"end":{"offset":24,"line":2,"column":13}},"environment":[{"variable":"1","value":"potato","range":{"start":{"offset":18,"line":2,"column":7},"end":{"offset":24,"line":2,"column":13}}}],"matched":"hello potato"}]}
|}];
