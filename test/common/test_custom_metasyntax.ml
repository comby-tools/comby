...
let%expect_test "custom_metasyntax_rewrite_fresh_1" =
  let syntax =
    Matchers.Metasyntax.
      [ Hole (Everything, Delimited (Some "$", None)); Hole (Alphanum, Delimited (Some "?", None)) ]
  in
...
let%expect_test "custom_metasyntax_rewrite_fresh_2" =
  let syntax =
    Matchers.Metasyntax.
      [ Hole (Everything, Delimited (Some "$", None)); Hole (Alphanum, Delimited (Some "?", None)) ]
  in
